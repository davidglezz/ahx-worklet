...
function b64decode(str: string): number[] {
  ...
  const b64r = Object.fromEntries(Array.from(b64, (ch, i) => [ch, i]));
  return str
    .match(/.{4}/g)!
    .map(([b1, b2, b3, b4]) => {
      const u24 = (b64r[b1] << 18) | (b64r[b2] << 12) | (b64r[b3] << 6) | b64r[b4];
...
const b64Noise =
  '';
const noise = new Int8Array(b64decode(b64Noise));
